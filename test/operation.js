...
describe('test _operation', function () {
    it('test "+" operator', function () {
        ...
        expect(rpn._operation['+'](0, -1)).equal(-1);
        expect(rpn._operation['+'](1, 2)).equal(3);
        expect(rpn._operation['+'](-1, 2)).equal(1);
        expect(rpn._operation['+']('3', '2')).equal(5);
    });
    ...
    it('test "-" operator', function () {
        ...
        expect(rpn._operation['-'](1, 2)).equal(1);
        expect(rpn._operation['-']('2', '3')).equal(1);
    });
    ...
    it('test "*" operator', function () {
        ...
        expect(rpn._operation['*'](0, -1)).equal(0);
        expect(rpn._operation['*'](1, 2)).equal(2);
        expect(rpn._operation['*'](-1, 2)).equal(-2);
        expect(rpn._operation['*']('3', '2')).equal(6);
    });
    ...
    it('test "/" operator', function () {
        ...
        expect(rpn._operation['/'](2, 1)).equal(0.5);
        expect(rpn._operation['/'](2, -1)).equal(-0.5);
        expect(rpn._operation['/']('2', '3')).equal(1.5);
    });
    ...
    it('test "^" operator', function () {
        ...
        expect(rpn._operation['^'](2, 0)).equal(0);
        expect(rpn._operation['^'](3, 2)).equal(8);
        expect(rpn._operation['^'](2, -1)).equal(1);
        expect(rpn._operation['^'](-1, 5)).equal(0.2);
        expect(rpn._operation['^'](-2, 5)).equal(0.04);
        expect(rpn._operation['^']('2', '3')).equal(9);
    });
